...
(function() {
	...
	if (!dataAlias.currentEmotions || dataAlias.currentEmotions === null || dataAlias.currentEmotions === 'undefined'){
		dataAlias.currentEmotions = Ti.App.boozerlyzer.db.selfAssessment.getLatestData(SessionID);
	}
	if (dataAlias.currentEmotions === null || dataAlias.currentEmotions[0].Happinessnow < 0 ){
		...
		dataAlias.currentEmotions= Ti.App.boozerlyzer.db.selfAssessment.newEmotion(false);
	}
	...
	var updated = Ti.App.boozerlyzer.dateTimeHelpers.prettyDate(dataAlias.currentEmotions[0].SelfAssessmentStart);
	...
	Ti.App.boozerlyzer.db.selfAssessment.setData(dataAlias.currentEmotions);
	...
	save.addEventListener('click',function()
	{
		...
		Ti.App.boozerlyzer.db.selfAssessment.setData(dataAlias.currentEmotions);
		Ti.App.boozerlyzer.db.sessions.Updated(SessionID);
		updated = Ti.App.boozerlyzer.dateTimeHelpers.prettyDate(dataAlias.currentEmotions[0].SelfAssessmentStart);
